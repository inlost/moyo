<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cat.aspx.cs" Inherits="moyu.Admin.infos.cat" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [id], [name] FROM [info_cat] WHERE (([deep] = @deep) AND ([father] = @father))">
            <SelectParameters>
