...
public class scrawlImgUp : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        {
            //上传配置
            string pathbase = "../../../upload/scrawlImgTemp/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" + DateTime.Now.Day + "/"; //保存路径
        ...
        {
            string pathbase = "../../../upload/scrawlImg/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" + DateTime.Now.Day + "/"; //保存路径//保存路径
