...
toolbars: [
['FullScreen','Source','Undo','Redo','InsertUnorderedList','InsertOrderedList','Unlink','Link','SelectAll','|','Print','SearchReplace','Preview','|','InsertImage','SnapScreen','Emotion','InsertVideo','Attachment','Date','Time','Anchor','Spechars','BlockQuote','HighlightCode','|','Bold','Italic','Underline','StrikeThrough','ForeColor','Superscript','Subscript','JustifyLeft','JustifyCenter','JustifyRight','JustifyJustify','Indent','RemoveFormat','FormatMatch','PastePlain','CustomStyle','Paragraph','RowSpacingBottom','RowSpacingTop','LineHeight','FontFamily','FontSize','ImageNone','ImageLeft','ImageRight','ImageCenter','|','InsertTable','MergeRight','MergeDown','SplittoRows','SplittoCols','SplittoCells','MergeCells','InsertCol','InsertRow','DeleteCol','DeleteRow','InsertParagraphBeforeTable']
],
labelMap: {
'fullscreen':'全屏','source':'源码','undo':'撤销','redo':'恢复','insertunorderedlist':'无序列表','insertorderedlist':'有序列表','unlink':'取消链接','link':'超链接','selectall':'全选','|':'分隔线','print':'打印','searchreplace':'查找替换','preview':'预览','|':'分隔线','insertimage':'图片','snapscreen':'屏幕截图','emotion':'表情','insertvideo':'视频','attachment':'附件','date':'日期','time':'时间','anchor':'锚点','spechars':'特殊字符','blockquote':'引用','highlightcode':'代码','|':'分隔线','bold':'加粗','italic':'斜体','underline':'下划线','strikethrough':'删除线','forecolor':'文字颜色','superscript':'上标','subscript':'下标','justifyleft':'左对齐','justifycenter':'居中','justifyright':'右对齐','justifyjustify':'两端对齐','indent':'首行缩进','removeformat':'清除格式','formatmatch':'格式刷','pasteplain':'纯文本粘贴','customstyle':'自定义样式','paragraph':'段落格式','rowspacingbottom':'段后间距','rowspacingtop':'段前间距','lineheight':'行间距','fontfamily':'字体','fontsize':'字号','imagenone':'图片默认','imageleft':'图片居左','imageright':'图片居右','imagecenter':'图片居中','|':'分隔线','inserttable':'插入表格','mergeright':'向右合并','mergedown':'向下合并','splittorows':'拆分成行','splittocols':'拆分成列','splittocells':'拆成单元格','mergecells':'合并单元格','insertcol':'前插入列','insertrow':'前插入行','deletecol':'删除列','deleterow':'删除行','insertparagraphbeforetable':'表格前插行'
},
iframeUrlMap: {
