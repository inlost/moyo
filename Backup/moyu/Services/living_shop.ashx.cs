...
namespace moyu.Services
{
    ...
    /// living_shop 的摘要说明
    /// </summary>
    public class living_shop : IHttpHandler, IRequiresSessionState
    {
        ...
        private void getShop()
        {
            ...
            Hashtable[] comments;
            theShop = myShop.shop_get_detal(Convert.ToInt32(theContext.Request.Params["id"]));
            ...
            sb.Append("<h3 id=\"d-s-c-title\">评价</h3>");
            comments = myShop.comment_get( Convert .ToInt32( theShop["id"]));
            foreach (Hashtable comment in comments)
            {
                sb.Append("<div class=\"d-s-c-comments\"><ul class=\"d-s-c-c-points clearfix\">");
                sb.Append("<li class=\"left clearfix\"><div class=\"left\">总评：</div><div class=\"rates left\" data-rated=\"" + comment["point"] + "\"></div></li>");
                sb.Append("<li class=\"left clearfix\"><div class=\"left\">价格：</div><div class=\"rates left\" data-rated=\"" + comment["quality"] + "\"></div></li>");
                sb.Append("<li class=\"left clearfix\"><div class=\"left\">服务：</div><div class=\"rates left\" data-rated=\"" + comment["service"] + "\"></div></li>");
                sb.Append("<li class=\"left clearfix\"><div class=\"left\">环境：</div><div class=\"rates left\" data-rated=\"" + comment["circumstance"] + "\"></div></li>");
                sb.Append("</ul><div class=\"d-s-c-c-body\">" + comment["comment"] + "</div>");
                sb.Append("<div class=\"d-s-c-c-time\">" + comment["voteTime"] + "</div></div>");
            }
